# greyScale - Grey Scale Conversion

## Description

This CUDA Runtime API sample is a very basic sample that implements color to grey conversion kernel. It is the same as the sample illustrating Chapter 3 of the programming guide with some additions like error checking.
